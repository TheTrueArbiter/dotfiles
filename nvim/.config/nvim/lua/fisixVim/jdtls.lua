print("JDTLS set up lua file called")
...
local function setup_jdtls()
    ...
    local on_attach = function(_, bufnr)
        ...
        print(vim.inspect(require('dap').configurations.java))
